import { ServiceExpert } from "public/icon";
import React from "react";

const ServiceCard = (props) => {
  return (
    <div
      className='bg-white py-7 px-6 rounded-md border border-red-700 shadow-lg font-montserrat'
      {...props}>
      <div className='header'>
        <div className='flex'>
          <div className='bg-mutedapp p-4 rounded-full'>
