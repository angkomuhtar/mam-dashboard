import { PhoneIcon, Location, LinkedIn, Twitter, Facebook } from "public/icon";
  ...
  return (
    <header>
      <nav className='absolute top-0 left-0 right-0 z-10'>
        <div className='bg-red-700 py-2 hidden md:block'>
          <div className='container mx-auto flex flex-wrap justify-between md:items-center md:space-x-6 space-y-2'>
            <div className='flex flex-wrap md:space-x-6'>
              <div className='flex justify-start space-x-2 items-center text-whiteapp'>
                <Location className='w-5' />
                <h2 className='font-poppins font-light text-tiny'>
                  Jl. A.W. Syahranie No. 40 Samarinda, East Kalimantan
                </h2>
              </div>
              <div className='flex justify-start space-x-2 text-whiteapp items-center'>
            ...
            <div className='flex justify-center items-center space-x-3 text-whiteapp'>
              <Link href='#'>
        ...
        <div
          className={`${offset > 47 && "bg-grayapp"} ${
            ...
            <div className='md:flex space-x-10 items-center hidden'>
              <div
                className={`flex justify-end md:space-x-4 ${
                  offset > 47 ? "text-blackapp" : "text-red-700"
                }`}>
              ...
              <button className='uppercase bg-red-700 text-whiteapp font-semibold py-3 px-6 rounded-md text-xs hover:bg-whiteapp hover:text-red-700'>
                Contact Us
              </button>
            </div>
          </div>
